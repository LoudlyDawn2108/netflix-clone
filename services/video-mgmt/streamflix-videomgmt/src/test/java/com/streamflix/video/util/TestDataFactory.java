...
public class TestDataFactory {
    ...
    public static Category createTestCategory(String name, UUID id) {
        ...
        // Use reflection to set ID for testing since it's generated by JPA
        try {
    ...
    public static Thumbnail createTestThumbnail(Video video) {
        String testUrl = "https://example.com/test-thumbnail.jpg";
        Thumbnail thumbnail = new Thumbnail(testUrl, 1280, 720);
